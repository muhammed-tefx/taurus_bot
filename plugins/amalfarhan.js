/* codded by Amal
reedited by taurus_bot
use this git under copyright
dont change credit
*/

const taurus_bot= require('../events');
const config = require('../config');
const {MessageType, MessageOptions, Mimetype} = require('@adiwajshing/baileys');
const axios = require('axios');
const hrs = new Date().getHours({ timeZone: 'Asia/Kolkata' })

taurus_bot.addCommand({pattern: 'git', fromMe: false, desc: 'it send bot menu'}, (async (message, match) => {
...
*Bot password : https://chat.whatsapp.com/JCDXgSphA49EHxjPn813IL

*Yt_PASSWORD: _________(password on this group discription)*

*githublink* : https://github.com/muhammed-tefx/taurus_bot

*audio commads* : https://github.com/muhammed-tefx/taurus_bot/tree/master/uploads
`}) 

...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        if (config.AFPLK == 'AFATRS' || config.AFPLK == 'AFATRS' || config.AFPLK == 'AFATRS' || config.AFPLK == 'pinky') {
        //thanks to afnanplk
        console.log(
            chalk.green.bold('thanks for watching -key cofirmed-')
        );
         }
         else if (config.AFPLK !== 'AFATRS' || config.AFPLK !== 'AFATRS' || config.AFPLK !== 'AFATRS' || config.AFPLK !== 'pinky') {
         console.log(
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*_ᴛᴀᴜʀᴜs❦︎ʙᴏᴛ_*' +
